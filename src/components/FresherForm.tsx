...
export const FresherForm: React.FC<FresherFormProps> = ({ onDataSubmit, initialData }) => {
  const [formData, setFormData] = useState<UserData>(
    initialData || {
      ...
      bio: "A passionate fresher looking for opportunities to grow and contribute.",
      education: [
        { degree: "Bachelor of Technology in Computer Science", institution: "University of Example", year: "2023" },
      ],
  ...
  return (
    <Card className="w-full max-w-2xl mx-auto">
      <CardHeader>
        <CardTitle>Fresher Portfolio Details</CardTitle>
        <CardDescription>Enter your academic and project details to build your portfolio.</CardDescription>
      </CardHeader>
